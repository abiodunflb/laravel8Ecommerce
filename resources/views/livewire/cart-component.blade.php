			...
			<div class=" main-content-area">
                        ...
                        <li class="pr-cart-item">
							...
							<div class="quantity">
								<div class="quantity-input">
									...
									<a class="btn btn-increase" wire:click.prvent="increaseQuantity('{{$item->rowId}}')" href="#"></a>
									<a class="btn btn-reduce" wire:click.prvent="decreaseQuantity('{{$item->rowId}}')" href="#"></a>
								</div>
							</div>
							<div class="price-field sub-total"><p class="price">${{$item->subtotal}}</p></div>
							<div class="delete">
								<a href="#" wire:click.prevent="deleteCart('{{$item->rowId}}')" class="btn btn-delete" title="">
				...
				<div class="summary">
					...
					<div class="update-clear">
						<a class="btn btn-clear" wire:click.prevent="deleteAllCart()" href="#">Clear Shopping Cart</a>
