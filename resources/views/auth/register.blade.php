							...
							<div class="register-form form-item ">
                                ...
                                <form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST" >
									...
									<fieldset class="wrap-input">
										...
										<input type="text" id="frm-reg-lname" :value="name" name="name" placeholder="Name" autocomplete="name" autofocus>
									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-reg-email">Email Address*</label>
										<input type="email" id="frm-reg-email" :value="email" name="email" placeholder="Email address" required>
									</fieldset>
